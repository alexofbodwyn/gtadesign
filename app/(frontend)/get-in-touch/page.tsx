import { ArrowLeftIcon, ChatBubbleOvalLeftIcon, EnvelopeIcon } from '@heroicons/react/24/outline'
      ...
      <div className="max-w-site w-full p-4">
        ...
        <div className="m-auto mt-6 max-w-[650px] flex-inline flex-col justify-center text-center">
          ...
          <p className="text-lg text-zinc-500 mt-6">
            Whether you know exactly what you need or just have an idea you want to discuss, I'd love to hear from you.
            No obligation, no sales pressure - just a friendly conversation about how I might be able to help.
          </p>
        </div>
        ...
        <div className="min-lg:grid min-lg:grid-cols-3 min-lg:gap-6 mt-10 mb-8">
          <div className="rounded-2xl p-6 border-2 border-zinc-300 col-span-2">
            ...
            <p className="text-lg text-zinc-500 mb-8">
              Fill in the form below and I'll get back to you within 24 hours (usually much sooner!)
            </p>
            <GetInTouchForm />
          </div>
          <div>
      ...
      <div className="bg-zinc-50 w-full mt-10 py-12">
        <div className="max-w-[1000px] w-full m-auto px-4">
          <div className="m-auto max-w-[650px] flex-inline flex-col justify-center text-center">
            ...
            <p className="text-lg text-zinc-500 mt-6">
              Before you get in touch, here are answers to questions I'm often asked
            </p>
          </div>
          <div className="min-lg:grid min-lg:grid-cols-2 min-lg:grid-rows-2 gap-6 mt-10 mb-8">
            <Card className="p-6 rounded-xl">
              ...
              <p className="mt-6 text-sm text-zinc-500">
                No! The first chat is always free with no obligation. It's a chance for us to understand each other and
                see if we're a good fit.
              </p>
            </Card>
            <Card className="mt-6 min-lg:mt-0 p-6 rounded-xl">
              <h3>What if I'm not sure what I need?</h3>
              <p className="mt-6 text-sm text-zinc-500">
                That's absolutely fine! Part of my job is helping you figure out what's right for your business. Just
            ...
            <Card className="mt-6 min-lg:mt-0 p-6 rounded-xl">
              ...
              <p className="mt-6 text-sm text-zinc-500">
                It varies - a logo might take 2-3 weeks, a website 6-8 weeks. I'll give you a realistic timeline upfront
            ...
            <Card className="mt-6 min-lg:mt-0 p-6 rounded-xl">
              ...
              <p className="mt-6 text-sm text-zinc-500">
                Yes! While I'm based locally and love supporting our community, I work with businesses throughout New
                Zealand and beyond via video calls.
              </p>
            </Card>
          </div>
        </div>
