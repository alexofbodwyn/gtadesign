  ...
  return (
    <div className="container max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <p>
          Your information is transmitted securely and stored by our email service provider. We do not sell, rent, or
          share your personal information with third parties except as necessary to respond to your inquiry.
        </p>

        <h2 className="text-2xl font-bold my-4 text-zinc-700">Third-Party Services</h2>
        <p>
          We use Resend (powered by Amazon SES) to send and receive emails. Your data may be processed by these services
